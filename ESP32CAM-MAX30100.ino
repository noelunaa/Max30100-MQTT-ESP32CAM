 ...
 * ritmo cardiaco (HR) y oxigenación (SpO2) por MQTT. Toma la biblioteca
...
#include <Wire.h> //Biblioteca de comunicacion I2C
#include "MAX30105.h" //Biblioteca del sensor
#include "spo2_algorithm.h" //Biblioteca para el calculo de la oxigenacion

//Datos de WiFi
const char* ssid = "Ubee87AA-2.4G";  // Aquí debes poner el nombre de tu red
const char* password = "3A4D9B87AA";  // Aquí debes poner la contraseña de tu red

//Datos del broker MQTT
const char* mqtt_server = "192.168.0.19"; // Si estas en una red local, coloca la IP asignada, en caso contrario, coloca la IP publica
